...
class CmsEditorTableItemController extends \App\Http\Controllers\Controller
{
    public function readOne(Table $table, TableItem $tableItem)
    {
        ...
        $fieldProperties = new \App\Services\Editor\FieldsProperties($properties ?? new stdClass());
    ...
    public function update(FormDataRequest $request, Table $table, TableItem $tableItem)
    {
        ...
        $fieldProperties = new \App\Services\Editor\FieldsProperties($properties);
